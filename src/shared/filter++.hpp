...
namespace AeraFilter
{
    ...
    public:
        ...
        virtual void array_done(aera_type_interface *tif, aera_item item);
        ...
        virtual void object_done(aera_type_interface *tif, aera_item item);
        ...
        virtual void attribute_done(aera_type_interface *tif, aera_item item);
        ...
        virtual void done(aera_type_interface *tif, aera_item item);
    };
